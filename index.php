...
<head>
   ...
   <!-- <link rel="stylesheet" href="<?php $this->options->themeUrl('/components/css/index.css'); ?>"> -->
   <link rel="stylesheet" href="<?php $this->options->themeUrl('/components/css/pagesCSS/index_pure.css'); ?>">
</head>
<body>
   ...
   <div class="index-body">
      ...
      <aside class="sidebar">
         ...
         <?php $this->need('./components/base/sidebar.php'); ?>
      </aside>
   </div>
